...

CF algorithms don’t require any domain knowledge.You need it.
...
Step 3: Select the neighborhood.Neighbors selection can be made using like Clustering,Top k,Threshold on similarity.Clustering is mostly used for Item based CF.Selecting threshold and k can be challenging
,depending on how well the similarity measure differentiates the between the users.
